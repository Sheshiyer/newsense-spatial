# newsense-launch — Project Status

> Auto-generated project snapshot · last scanned 2026-07-28 · regenerable via `_scan_projects.py` + `_generate_status.py`

## 🔗 Links

- **GitHub repo:** https://github.com/Sheshiyer/newsense-spatial
- **Issues / roadmap board:** https://github.com/Sheshiyer/newsense-spatial/issues

## 📍 Where the project is at (git state)

- **Branch:** `main`
- **Last commit:** `f49149b` · 2026-06-06 · fix(deploy): remove Git LFS tracking for GLB models
- **Uncommitted changes:** 2 file(s)
- **Package:** `newsense` (node)
...
- [ ] Commit or stash 2 uncommitted change(s)
